                ...
                if (message == "botinfo") {
                    client.simpleEmbed({
                        ...
                        client.embed({
                            ...
                            fields: [
                                {
                                    name: `🤖┆What is Smartboi?`,
                                    value: `Smarboi is a bot with which you can run your entire server! With no less than 400+ commands, it can be used for a large variety of tasks. The bot has an ai integration which can use chatgpt to generate prompts`,
                                },
                                {
                                    name: `🎶┆What is Bot 2?`,
