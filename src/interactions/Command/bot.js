...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('ai')
                .setDescription('Use chatgpt ai \n **Note**: this is not a slash command Usage::  /ai {message} ')
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName('ping')
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('changelogs')
                .setDescription('Get bot changelogs')
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName('donate')
                .setDescription('Get Bot donate link')
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName('links')
                .setDescription('Get all Bot links')
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName('owner')
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('vote')
                .setDescription('Check if you have voted')
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName('feedback')
