    ...
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .addNumberOption(option => option.setName('day').setDescription('The date of your birth').setRequired(true))
                .addNumberOption(option => option.setName('month').setDescription('Your birth month').setRequired(true))
        )
    ,
