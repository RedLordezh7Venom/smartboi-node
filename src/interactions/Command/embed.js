        ...
        .addOptions([
          {
            emoji: "✏️",
            label: "Title",
            description: "Create embed title",
            value: "title_embed",
          },
          {
            emoji: "💬",
            label: "Description",
            description: "Create embed description",
            value: "description_embed",
          },
          {
            emoji: "🕵️",
            label: "Author",
            description: "Create embed author",
            value: "author_embed",
          },
          {
            emoji: "🔻",
            label: "Footer",
            description: "Create embed footer",
            value: "footer_embed",
          },
          {
            emoji: "🔳",
            label: "Thumbnail",
            description: "Create embed thumbnail",
            value: "thumbnail_embed",
          },
          {
            emoji: "🕙",
            label: "Timestamp",
            description: "Create embed timestamp",
            value: "timestamp_embed",
          },
          {
            emoji: "🖼️",
            label: "Image",
            description: "Create embed image",
            value: "image_embed",
          },
          {
            emoji: "🌐",
            label: "URL",
            description: "Create embed url",
            value: "url_embed",
          },
          {
            emoji: "🔵",
            label: "Color",
            description: "Create embed color",
            value: "color_embed",
          },
        ])
    );
