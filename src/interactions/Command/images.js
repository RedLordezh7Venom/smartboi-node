...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('images')
        .setDescription('See all the images')
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('memes')
                .setDescription('See all the memes I got')
                .addSubcommand((subcommand) =>
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('animals')
                .setDescription('See all the animal images I got')
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('bird')
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('user')
                .setDescription('See all the user images')
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('ad')
                ...
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('bed')
                        .setDescription('Creates a bed meme')
                        .addUserOption((option) =>
                ...
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('blur')
                        .setDescription('Gives a blurred image')
                        .addUserOption((option) =>
                ...
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('burn')
                        .setDescription('Gives a burned image')
                        .addUserOption((option) =>
                ...
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('darkness')
                        .setDescription('Gives a darkness image')
                        .addUserOption((option) =>
                ...
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('invert')
                        .setDescription('Invert an image')
                        .addUserOption((option) =>
                ...
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('wanted')
                        .setDescription('Wanted level a user')
                        .addUserOption((option) =>
        ...
        .addSubcommandGroup((group) =>
            group
                .setName('extra')
                .setDescription('See all the extra images')
                .addSubcommand((subcommand) =>
                    subcommand
                        .setName('car')
