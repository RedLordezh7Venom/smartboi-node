    ...
    if (message == "ourbots") {
        client.simpleEmbed({
            ...
            client.embed({
                ...
                fields: [
                    {
                        name: `📘┆What is SmartBot?`,
                        value: `Smartboi is a bot which is based on chatgpt prompts integrated into discord, users can use the bot to generate AI prompts on discord. With no less than 250+ commands, Smartboi can be used to run entire servers!`,
                    },
                    {
