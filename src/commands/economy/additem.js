...
module.exports = async (client, interaction, args) => {
    ...
    if(role == interaction.guild.roles.everyone) return client.errNormal({ error: "You cannot add the everyone role to the store, smarty!", type: 'editreply' }, interaction);
