...
module.exports = async (client, interaction, args) => {
    ...
    Schema.findOne({ Guild: interaction.guild.id, User: user.id }, async (err, data) => {
        if (data) {
            ...
            if (money > data.Money) return client.errNormal({ error: `You can't bet more than you have, smarty!`, type: 'editreply' }, interaction);
            ...
            async function endGame() {
                if (player.score === 21) {
                    ...
                    await endMsg(
                        `Win! You got 21!`,
                        `Smartboi had ${dealer.score.toString()}`,
                        `GREEN`
                    );
                }
                if (player.score > 21) {
                ...
                if (dealer.score > 21) {
                    ...
                    gameOver = true;
                    await endMsg(
                        `Win! SmarBoi reached over 21!`,
                        `SmarBoi had ${dealer.score.toString()}`,
                        `GREEN`
                    );
                }
                if (
                ...
                if (
                    ...
                    gameOver = true;
                    await endMsg(
                        `Nigga you lost haha! SmarBoi won! Cope. `,
                        `SmarBoi had ${dealer.score.toString()}`,
                        `RED`
                    );
                }
                if (
                    ...
                    gameOver = true;
                    await endMsg(`Tie!`, `Smartboi had ${dealer.score.toString()}`, `RED`);
                }
            }
