    ...
    return Promise.all(promises)
        .then(async results => {
            ...
            client.embed({
               ...
               {
                    name: "ℹ️┆Information",
                    value: `Smartboi is an openai integrated bot with which you can run ChatGPT prompts! The bot has 250+ commands and additional functionality to run your entire server!`,
                    inline: false,
                },
                {
                    name: "_____ \n\n│General",
                ...
                {
                    name: "🔗┆Links",
                    value: `Add me: [[Bot Link]](${client.config.discord.botInvite}) \nSupport server: [[Smartboi]](${client.config.discord.serverInvite})`,
                    inline: false,
                }],
                type: 'editreply'
            }, interaction)
