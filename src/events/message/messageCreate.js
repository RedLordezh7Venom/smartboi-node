...
module.exports = async (client, message) => {
  ...
  if (
    ...
    client
      .embed(
        {
          title: "Hi, i'm smartboi",
          desc: `Use with commands via Discord ${client.emotes.normal.slash} commands`,
          fields: [
            {
              name: "📨┆Invite me",
              value: `Invite smartboi in your own server! [Click here](${client.config.discord.botInvite})`,
            },
            {
              name: "❓┇I don't see any slash commands",
              value:
                "smartboi may not have permissions for this. Open the invite link again and select your server. Smartboi would then get the correct permissions",
            },
            {
              name: "❓┆Need support?",
  ...
  if (command) {
    ...
    client.embed(
      {
        title: "👋・Hi, i'm Bot",
        desc: `Smartboi is now completely in ${client.emotes.normal.slash} commands. The current message commands have expired! Try our new improved commands and make your server better with Smartboi!`,
        fields: [
          {
            name: "❓┇I don't see any slash commands",
            value:
